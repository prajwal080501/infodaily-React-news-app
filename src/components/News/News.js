...
export class News extends Component {
  ...
  constructor() {
    super();
    console.log(" Im a cosntructor babay!");
    this.state = {
      articles: this.articles,
    };
  }

  async componentDidMount() { //promise method 
    let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=6843ae437891467ba8f6f3cae0ade156";
  ...
  render() {
    return (
      <div className="container" my-4>
        <h2 className="headline">InfoDaily - Top Headlines</h2>
        <div className="row">
          {" "}
